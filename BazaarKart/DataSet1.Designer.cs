...
namespace BazaarKart {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Product_name, int Product_qty) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public int Product_qty {
                get {
                    return ((int)(this[this.tableProducts.Product_qtyColumn]));
                }
                set {
                    this[this.tableProducts.Product_qtyColumn] = value;
                }
            }
        }
...
namespace BazaarKart.DataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Product_name], [Product_qty]) VALUES (@Product_nam" +
                "e, @Product_qty)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [Product_name] = @Product_name, [Product_qty] = @Prod" +
                "uct_qty WHERE (([Id] = @Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Product_name, Product_qty FROM dbo.Products";
        ...
        public virtual int Insert(string Product_name, int Product_qty) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(Product_qty));
        ...
        public virtual int Update(string Product_name, int Product_qty, int Original_Id) {
            if ((Product_name == null)) {
                throw new global::System.ArgumentNullException("Product_name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Product_qty));
